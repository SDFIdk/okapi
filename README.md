...
3. Indsæt `<script>`-tag på din hjemmeside
   - Benyt enten vores CDN: `<script type="module">import {Initialize} from "https://cdn.jsdelivr.net/npm/@dataforsyningen/okapi@3.0.0"</script>`
...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/@dataforsyningen/okapi@3.0.0/dist/okapi.min.css" rel="stylesheet">
  ...
</head>
<body>
  ...
  ...
  <script type="module">
    import { Initialize } from 'https://cdn.jsdelivr.net/npm/@dataforsyningen/okapi@3.0.0'
    new Initialize({})
  </script>
...
Vores standard styling kan findes her: https://cdn.jsdelivr.net/npm/@dataforsyningen/okapi@3.0.0/dist/okapi.min.css
...
<p style="text-align: center;"><img src="docs/img/google.2.png" alt="forhåndsvisning"></p>
...
<p style="text-align: center;"><img src="docs/img/dawa.png" alt="forhåndsvisning"></p>
