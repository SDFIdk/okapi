...
3. Indsæt `<script>`-tag på din hjemmeside
   - Benyt enten vores CDN: `<script type="module">import {Initialize} from "https://cdn.jsdelivr.net/npm/@dataforsyningen/okapi@2.4.0"</script>`
...
Vores standard styling kan findes her: https://cdn.jsdelivr.net/npm/@dataforsyningen/okapi@2.4.0/dist/okapi.min.css
